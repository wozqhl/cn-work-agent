...
Operations (19): getHealth, getReady, getMetrics, getOpenApi, getPlatforms, getConfig, postWebhookFeishu, postWebhookDingtalk, getWebhookWecom, postWebhookWecom, listApprovals, getApprovalsCsv, getApprovalsMd, getApprovalsHtml, getApprovals, getApprovalCard, getApproval, decideApprovalGet, decideApproval
...
```json
{
  "mcpServers": {
    "cn_work_agent_api": {
      ...
      "env": {
        "MCP_BASE_URL": "http://127.0.0.1:8790"
      }
    },
    "cn_work_agent_api-py": {
      "command": "python3",
      "args": [
        "./mcp_server.py"
      ],
